...
短期记忆，也叫运存，是能够暂时储存信息、以供认知过程操作的能力。先前研究\*估计，短期记忆大概能记住7个事件块（=chunk）；近期研究\*\*则估计为4个块。短期记忆的保持时间一般在18-30秒， Peterson 氏和 Peterson 氏***让受试在听到声响后开始回忆事情，而控制组则必须听到声响后先倒数三个数后以阻止思维复现，结果显示在18秒后控制组的回忆率降到5%。
